...
const GITHUB = 'https://github.com/viehao/vkara/blob/main';
...
- [OpenSpec specs](https://github.com/viehao/vkara/tree/main/openspec/specs/url-command-surface): design and security specs
`;
}
