...
shell work in [#5](https://github.com/viehao/vkara/pull/5). This tree continues that
...
and [#6](https://github.com/viehao/vkara/issues/6)).
...
4. If jsDelivr fails, sideload WGT from a `tizen-v*` [GitHub Release](https://github.com/viehao/vkara/releases).
...
`release-tizen.yml` on `viehao/vkara`. First publish may need
