...
[npm](https://npm.im/@vkara/tv) · [source](https://github.com/viehao/vkara/tree/main/apps/tizen)
...
If jsDelivr / Module Manager fails, sideload the unsigned WGT from a `tizen-v*` [GitHub Release](https://github.com/viehao/vkara/releases) with [Apps2Samsung](https://github.com/Apps2Samsung/Apps2Samsung).
...
See [apps/tizen/README.md](https://github.com/viehao/vkara/blob/main/apps/tizen/README.md) for build, WGT sideload, and maintainer release (`tizen-v*`).

Inspired by [@alfrededison](https://github.com/alfrededison)’s Tizen shell work in [#5](https://github.com/viehao/vkara/pull/5).
