...
pkg.setdefault("repository", {})["url"] = "https://github.com/viehao/vkara"
...
rm -f "$TIZEN_DIST_DIR"/vkara-tv-*.tgz "$TIZEN_DIST_DIR"/viehao-vkara-*.tgz "$TIZEN_DIST_DIR"/vkara-[0-9]*.tgz "$TIZEN_DIST_DIR"/vkara-tizenbrew-*.tgz
