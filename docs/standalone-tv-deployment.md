...
│ WGT or TizenBrew  │          │ <your-app>.vercel.app/tv  │           │ vkara-realtime.viehao.io.vn  │
└──────────────────┘          └──────────────────────────┘           └────────────────────────────┘
```
...
`viehao/vkara-api` Docker image and change two env vars below.
...
see [#6](https://github.com/viehao/vkara/issues/6) if missing on upstream
`main`).
...
```
NEXT_PUBLIC_API_URL        = https://vkara-realtime.viehao.io.vn
NEXT_PUBLIC_WS_URL         = wss://vkara-realtime.viehao.io.vn/ws
NEXT_PUBLIC_TIKTOK_API_URL = https://vkara-tiktok-api.viehao.io.vn
...
[#6](https://github.com/viehao/vkara/issues/6). Packaging the shell
...
- **White/blank screen on the TV, site fine on desktop** — usually the hosted
  ...
  [#6](https://github.com/viehao/vkara/issues/6) (Chrome 76 / Tizen 6.0).
