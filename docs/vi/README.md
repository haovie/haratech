...
| Image | Port | Ghi chú |
|-------|------|---------|
| `viehao/vkara-aio` | 3000 | Chạy cả web và backend, khuyến nghị dùng thử trước |
| `viehao/vkara-web` | 3000 | Chỉ frontend |
| `viehao/vkara-api` | 8000 | Chỉ API, cần tự chuẩn bị Redis |
| `viehao/vkara-api-redis` | 8000 | API + Redis trong cùng container; Redis không publish ra ngoài |
...
[@alfrededison](https://github.com/alfrededison) trong [#5](https://github.com/viehao/vkara/pull/5) —
...
<p align="center">
  Phát triển bởi <a href="https://github.com/viehao">@viehao</a><br />
