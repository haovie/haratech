...
Copyright complaints, takedown requests, and support: 
...
```bash
git clone https://github.com/viehao/vkara.git
cd vkara
bun install
```
...
docker run -d --name vkara-redis -p 6379:6379 redis:7-alpine \
  redis-server --requirepass viehao
```
...
| Image                          | Port | Notes                                                |
| ------------------------------ | ---- | ---------------------------------------------------- |
| `viehao/vkara-aio`       | 3000 | Full stack (recommended)                             |
| `viehao/vkara-web`       | 3000 | Frontend only                                        |
| `viehao/vkara-api`       | 8000 | API only (bring your own Redis)                      |
| `viehao/vkara-api-redis` | 8000 | API + Redis in one container; Redis is internal only |
...
work in [#5](https://github.com/viehao/vkara/pull/5) — thank you for sharing that path with the community.
...
<p align="center">
  Made by <a href="https://github.com/viehao">@viehao</a><br />
  From Vietnam with love ♥
</p>

<p align="center">
  <a href="https://github.com/viehao/vkara">github.com/viehao/vkara</a>
</p>
