...
- Update docs and GitHub [#6](https://github.com/viehao/vkara/issues/6) acceptance from chrome85/Tizen 6.5 to chrome76/Tizen 6.0.
...
- Closes / retargets [#6](https://github.com/viehao/vkara/issues/6).
